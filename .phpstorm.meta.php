...
'filesystems.links.C:\\Users\\Lenovo\\Desktop\\laravel\\larazillow\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'debugbar.debug_backtrace_limit','inertia.ssr.enabled','inertia.ssr.runtime','inertia.ssr.ensure_runtime_exists','inertia.ssr.url',
...
'inertia.testing.ensure_pages_exist','inertia.expose_shared_prop_keys','inertia.history.encrypt','ide-helper.filename','ide-helper.models_filename',
...
'signed','throttle','verified',);
        registerArgumentsSet('routes', 'listing.index','listing.show',
'listing.offer.store','notification.index','notification.seen','login','login.store',
'logout','user-account.create','user-account.store','realtor.listing.restore','realtor.listing.index',
...
'MYSQL_ATTR_SSL_CA','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH',
'SESSION_DOMAIN','BROADCAST_CONNECTION','FILESYSTEM_DISK','QUEUE_CONNECTION','CACHE_DRIVER',
