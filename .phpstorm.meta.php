...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\Lenovo\Desktop\laravel\larazillow\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\Lenovo\\Desktop\\laravel\\larazillow\\public\\storage','logging.default','logging.deprecations.channel',
...
'session.partitioned','session.serialization','debugbar.enabled','debugbar.collect_jobs','debugbar.except',
...
'debugbar.options.db.backtrace_exclude_paths','debugbar.options.db.backtrace_editor_links','debugbar.options.db.timeline','debugbar.options.db.duration_background','debugbar.options.db.explain.enabled',
'debugbar.options.db.show_query_result','debugbar.options.db.only_slow_queries','debugbar.options.db.slow_threshold','debugbar.options.db.memory_usage','debugbar.options.db.soft_limit',
...
'debugbar.options.logs.file','debugbar.options.config.masked','debugbar.options.cache.values','debugbar.options.cache.timeline','debugbar.options.http_client.masked',
...
'debugbar.route_domain','debugbar.theme','debugbar.debug_backtrace_limit','inertia.ssr.enabled','inertia.ssr.runtime',
'inertia.ssr.ensure_runtime_exists','inertia.ssr.url','inertia.ssr.ensure_bundle_exists','inertia.ssr.throw_on_error','inertia.pages.ensure_pages_exist',
...
'debugbar.openhandler','debugbar.cache.delete','debugbar.queries.explain','debugbar.clockwork','debugbar.assets','listing.create','listing.store',
'listing.edit','listing.update','listing.destroy','listing.index','listing.show',
...
'C:.Users.Lenovo.Desktop.laravel.larazillow.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
